...
st.markdown("""
<style>
.stApp {background: linear-gradient(135deg, #fefbd8, #ffecd2); font-family: 'Poppins', sans-serif;}
.title {font-size: 60px; font-weight: 900; text-align: center; color: #006400; text-shadow: 0px 0px 15px #32CD32;}
.subtitle {font-size: 22px; text-align: center; color: #2E8B57; margin-bottom: 30px;}
.prediction {font-size: 50px; font-weight: 900; text-align: center; margin-top: 15px; color: #FF4500 !important; text-shadow: 0px 0px 20px #FFA07A;}
.confidence {font-size: 24px; text-align: center; color: #8B0000; margin-bottom: 15px;}
.footer {color: #555555; font-size: 16px; text-align: center; margin-top: 40px;}
hr {border: 2px solid #32CD32; margin-bottom: 40px;}
[data-testid="stFileUploader"] section {background-color: #fffacd !important; border: 2px dashed #32CD32; border-radius: 12px; padding: 25px;}
[data-testid="stFileUploader"] label {color: #32CD32 !important; font-size: 18px; font-weight: bold;}
[data-testid="stFileUploader"] button {background-color: #32CD32 !important; color: black !important; font-weight: bold; border-radius: 8px; padding: 8px 20px;}
[data-testid="stFileUploader"] button:hover {background-color: #228B22 !important; color: black !important;}
...
# -------------------------------
# Step 2: Load model using TFSMLayer (Keras 3)
# -------------------------------
try:
